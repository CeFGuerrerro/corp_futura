 ...
 * @author o-a19
 */
public class DS_Solicitud implements JRDataSource {
        ...
        if (null != jrf.getName()) {
            switch (jrf.getName()) {
                ...
                case "telconyugue":
                    ...
                    return valor;
//                case "parentesco":
//                    for(Familiares f:listaSolicitudes.get(indice).getDatosPersonales().getFamiliaresList()){
//                    valor = f.getParentesco();
//                    return valor; }
